...
class DetectLevelNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('detect.level.red.saturation_l', 200, descriptor=sat_l_descriptor)
        self.declare_parameter('detect.level.red.saturation_h', 255, descriptor=sat_h_descriptor)
        self.declare_parameter('detect.level.red.lightness_l', 200, descriptor=light_l_descriptor)
        ...
        self.pub_level_type = self.create_publisher(String, '/detect/level/type', 1)
    ...
    def find_rect_of_level(self, mask):
        ...
        if len(keypts) >= 3:
            ...
            if dx == 0 or abs(slope) > 2.0:
                ...
                self.pub_level_type.publish(msg)
            else:
