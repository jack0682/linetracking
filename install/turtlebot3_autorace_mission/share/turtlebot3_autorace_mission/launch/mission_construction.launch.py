...
def generate_launch_description():
    ...
    # Modified: 2025-08-26 12:00 - Fixed control flow architecture  
    # - control_lane sends to /lane_cmd_vel
    # - avoid_construction routes commands based on navigation state
    # - cmd_vel_mux selects between lane and navigation commands
    ...
    control_node = Node(
            ...
            remappings=[
                ...
                ('/control/cmd_vel', '/lane_cmd_vel')  # Modified: 2025-08-26 12:00 - Route to arbiter
            ]
        )

    # Navigation trigger node - monitors position and triggers navigation when needed
    navigation_trigger_node = Node(
        package='turtlebot3_autorace_mission',
        executable='navigation_trigger.py',
        name='navigation_trigger',
        output='screen'
    )
    
    # Command velocity multiplexer - routes final commands to robot
